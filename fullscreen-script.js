// Ironclad Roofing - Fullscreen Chat Widget
class FullscreenRoofingEstimator {
    constructor() {
        this.currentStep = 0;
        this.userData = {};
    ...
    startConversation() {
        ...
        setTimeout(() => {
            this.addMessage('👋 Welcome! I\'m here to help you get a quick estimate for your roofing project. Let\'s get started!', 'bot');
            setTimeout(() => {
...
Date: ${timestamp}`;
    ...
    async sendToFormspree(estimate) {
        ...
        try {
            ...
            formData.append('source', 'Ironclad Roofing Fullscreen Chat Widget');
...
document.addEventListener('DOMContentLoaded', () => {
    new FullscreenRoofingEstimator();
});

// Make it available globally for embedding
window.FullscreenRoofingEstimator = FullscreenRoofingEstimator;