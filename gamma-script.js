// Ironclad Roofing - Gamma-Style Automated AI Estimate System
class GammaStyleRoofingEstimator {
    constructor() {
        this.currentStep = 0;
        this.userData = {};
        ...
        this.config = {
            ...
            formspreeEndpoint: 'https://formspree.io/f/xld1lenb'
        };
        
        // Conversation flow - NO EMOJIS
        this.questions = [
            {
                key: 'name',
            ...
            {
                key: 'email', 
                question: "What's your email address? Your estimate will be sent here immediately after completion.",
                type: 'email'
            },
            {
                key: 'phone',
    ...
    startConversation() {
        setTimeout(() => {
            this.addMessage('Welcome to Ironclad Roofing. I\'ll help you get an instant AI-powered roofing estimate that will be sent directly to your email. Let\'s get started with some basic information.', 'bot');
            setTimeout(() => {
    ...
    async generateAIEstimate() {
        this.addMessage('Perfect. I have all the information needed to generate your personalized roofing estimate. Our AI system is now analyzing your project requirements...', 'bot');
        this.showLoading();
        ...
        try {
            ...
            if (result.success) {
                ...
                setTimeout(() => {
                    this.addMessage(`Your detailed estimate has been sent to ${this.userData.email}. Please check your inbox and spam folder. Our team will also follow up within 24 hours to schedule a consultation.`, 'bot', 'success-message');
                }, 2500);
    ...
    displayAIEstimate(estimate) {
        this.addMessage('Your AI-powered roofing estimate has been generated successfully.', 'bot');
        ...
        estimateHeader.innerHTML = `
            ...
            <strong>Your Personalized Roofing Estimate</strong>
        `;
        
        const estimateText = document.createElement('div');
        estimateText.innerHTML = estimate.replace(/\n/g, '<br>');
        estimateText.style.marginTop = '20px';
        estimateText.style.lineHeight = '1.7';
    ...
    async sendFallbackNotification() {
        try {
            ...
            formData.append('_subject', `URGENT LEAD: ${this.userData.name} - AI System Issue`);
...
document.addEventListener('DOMContentLoaded', () => {
    new GammaStyleRoofingEstimator();
});

// Make available globally
window.GammaStyleRoofingEstimator = GammaStyleRoofingEstimator;